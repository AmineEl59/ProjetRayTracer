...
public class Scene {
    ...
    public List<AbstractLight> getLights() { return Collections.unmodifiableList(lights); }
    ...
    public void addVertex(Point vertex) { this.vertices.add(vertex); }

    public int getMaxVerts() { return maxVerts; }
    public void setMaxVerts(int maxVerts) { this.maxVerts = maxVerts; }
